...
colours, hit sounds, co-op buddies, the weapon lists behind eight flags and two damage rules all import (`build/mods/GE-X_6a_01-19-25/`, importer version 19); what is left is the code
...
1. **Regenerate the list** — the summary is the work queue, largest first:
   ...
   need reading. Remaining rewritten, by size: `beam_render` (14 words),
