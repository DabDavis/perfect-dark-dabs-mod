...
// The text palettes, IA16 entries: intensity high, alpha low. The port keeps
// them in N64 byte order like a palette out of the ROM, because the TLUT load
// in the renderer byte-swaps every entry as if it came from there; left in
// host order they read back with intensity and alpha exchanged and every
// glyph is a filled block. PD_BE16 is the identity on the N64 build.
u16 var8007fb3c[] = {
	PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00),
	PD_BE16(0xff00), PD_BE16(0xff24), PD_BE16(0xff48), PD_BE16(0xff6c), PD_BE16(0xff90), PD_BE16(0xffb4), PD_BE16(0xffd8), PD_BE16(0xffff),
};

u16 var8007fb5c[] = {
	PD_BE16(0xff00), PD_BE16(0xff58), PD_BE16(0xff74), PD_BE16(0xff90), PD_BE16(0xffac), PD_BE16(0xffc8), PD_BE16(0xffe4), PD_BE16(0xffff),
	PD_BE16(0xffff), PD_BE16(0xffff), PD_BE16(0xffff), PD_BE16(0xffff), PD_BE16(0xffff), PD_BE16(0xffff), PD_BE16(0xffff), PD_BE16(0xffff),
	PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00), PD_BE16(0xff00),
	PD_BE16(0xff00), PD_BE16(0xff18), PD_BE16(0xff30), PD_BE16(0xff5c), PD_BE16(0xff88), PD_BE16(0xffb4), PD_BE16(0xffd8), PD_BE16(0xffff),
};

#if VERSION == VERSION_JPN_FINAL
u16 var800801d8jf[] = {
	PD_BE16(0xff00), PD_BE16(0xff11), PD_BE16(0xff22), PD_BE16(0xff33), PD_BE16(0xff44), PD_BE16(0xff55), PD_BE16(0xff66), PD_BE16(0xff77),
	PD_BE16(0xff88), PD_BE16(0xff99), PD_BE16(0xffaa), PD_BE16(0xffbb), PD_BE16(0xffcc), PD_BE16(0xffdd), PD_BE16(0xffee), PD_BE16(0xffff),
};
#endif
