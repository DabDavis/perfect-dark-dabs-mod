...
struct weapon invitem_ecmmine = {
	...
	WEAPONFLAG2_MISSIONCRITICAL | WEAPONFLAG2_LANDSONHIT | WEAPONFLAG2_NORELOADSOUND | WEAPONFLAG2_NOPICKUPWHILEARMED | WEAPONFLAG2_STICKSTOWALL, // flags2
	0, // unequipped reload index
	SFX_PICKUP_MINE, // pickup sound
};
...
struct weapon invitem_combatknife = {
	...
	WEAPONFLAG2_NORELOADSOUND | WEAPONFLAG2_PICKUPSINGLE | WEAPONFLAG2_NOPICKUPINFLIGHT | WEAPONFLAG2_STICKSTOWALL, // flags2
	0, // unequipped reload index
...
struct weapon invitem_commsrider = {
	...
	WEAPONFLAG2_LANDSONHIT | WEAPONFLAG2_NORELOADSOUND | WEAPONFLAG2_NOPICKUPWHILEARMED | WEAPONFLAG2_STICKSTOWALL, // flags2
	0, // unequipped reload index
	SFX_PICKUP_MINE, // pickup sound
};
