...
struct weapon invitem_timedmine = {
	...
	WEAPONFLAG3_TIMEDFUSE | WEAPONFLAG3_HELDMUZZLE | WEAPONFLAG3_BOTIGNORES, // flags3
};
...
struct weapon invitem_proximitymine = {
	...
	0, // unequipped reload index
	SFX_PICKUP_MINE, // pickup sound
	WEAPONFLAG3_HELDMUZZLE | WEAPONFLAG3_BOTIGNORES, // flags3
};
...
struct weapon invitem_combatknife = {
	...
	WEAPONFLAG3_THROWNBLADE, // flags3
};
