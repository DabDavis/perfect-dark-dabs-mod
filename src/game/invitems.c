...
struct weapon invitem_falcon2 = {
	...
	WEAPONFLAG2_BLUNTMELEE | WEAPONFLAG2_PISTOLCASING, // flags2
	0, // unequipped reload index
	0, // pickup sound
	WEAPONFLAG3_LASERSIGHT, // flags3
};
...
struct weapon invitem_magsec = {
	...
	WEAPONFLAG2_PISTOLCASING, // flags2
};
...
struct weapon invitem_cyclone = {
	...
	WEAPONFLAG_ONEHANDED | WEAPONFLAG_AICANUSE | WEAPONFLAG_DUALFLIP | WEAPONFLAG_00000040 | WEAPONFLAG_TRACKTIMEUSED | WEAPONFLAG_00000400 | WEAPONFLAG_DUALWIELD | WEAPONFLAG_00002000 | WEAPONFLAG_00004000 | WEAPONFLAG_HASHANDS,
	WEAPONFLAG2_FAINTTRACER, // flags2
};
...
struct weapon invitem_shotgun = {
	...
	WEAPONFLAG_AICANUSE | WEAPONFLAG_00000040 | WEAPONFLAG_TRACKTIMEUSED | WEAPONFLAG_00000400 | WEAPONFLAG_00002000 | WEAPONFLAG_00004000 | WEAPONFLAG_HASHANDS,
	WEAPONFLAG2_UNEQUIPPEDRELOAD | WEAPONFLAG2_PUMPACTION | WEAPONFLAG2_SHOTGUNDAMAGE | WEAPONFLAG2_PELLETS, // flags2
	1, // unequipped reload index
	0, // pickup sound
	WEAPONFLAG3_SHOTGUNMODEL | WEAPONFLAG3_SHELLPARTS, // flags3
};
...
struct weapon invitem_timedmine = {
	...
	WEAPONFLAG3_TIMEDFUSE | WEAPONFLAG3_HELDMUZZLE | WEAPONFLAG3_BOTIGNORES | WEAPONFLAG3_KEEPSFUNCTION, // flags3
};
...
struct weapon invitem_remotemine = {
	...
	0, // unequipped reload index
	SFX_PICKUP_MINE, // pickup sound
	WEAPONFLAG3_REMOTEDETONATED | WEAPONFLAG3_HELDMUZZLE | WEAPONFLAG3_BOTIGNORES, // flags3
};
...
struct weapon invitem_proximitymine = {
	...
	0, // unequipped reload index
	SFX_PICKUP_MINE, // pickup sound
	WEAPONFLAG3_HELDMUZZLE | WEAPONFLAG3_BOTIGNORES | WEAPONFLAG3_KEEPSFUNCTION, // flags3
};
...
struct weapon invitem_grenade = {
	...
	WEAPONFLAG3_FUSETIMER | WEAPONFLAG3_EJECTSPIN | WEAPONFLAG3_HELDMUZZLE | WEAPONFLAG3_GRENADEARC | WEAPONFLAG3_PINBALL | WEAPONFLAG3_BOTIGNORES, // flags3
};
...
struct weapon invitem_nbomb = {
	...
	0, // unequipped reload index
	0, // pickup sound
	WEAPONFLAG3_EJECTSPIN | WEAPONFLAG3_HELDMUZZLE | WEAPONFLAG3_GRENADEARC | WEAPONFLAG3_BOTIGNORES, // flags3
};
...
struct weapon invitem_tranquilizer = {
	...
	0, // unequipped reload index
	0, // pickup sound
	WEAPONFLAG3_NOSPARKS | WEAPONFLAG3_EJECTSDART, // flags3
};
...
struct weapon invitem_sniperrifle = {
	...
	0, // unequipped reload index
	0, // pickup sound
	WEAPONFLAG3_SNIPERSCOPE, // flags3
};
...
struct weapon invitem_watchlaser = {
	...
	L_GUN_000, // description
	WEAPONFLAG_AICANUSE | WEAPONFLAG_00000040 | WEAPONFLAG_TRACKTIMEUSED | WEAPONFLAG_DUALWIELD,
	WEAPONFLAG2_LASERFLIGHT, // flags2
};
...
struct weapon invitem_combatknife = {
	...
	WEAPONFLAG2_NORELOADSOUND | WEAPONFLAG2_PICKUPSINGLE | WEAPONFLAG2_NOPICKUPINFLIGHT | WEAPONFLAG2_STICKSTOWALL | WEAPONFLAG2_POISONS | WEAPONFLAG2_BLADEHIT, // flags2
	0, // unequipped reload index
	SFX_PICKUP_KNIFE, // pickup sound
	WEAPONFLAG3_THROWNBLADE | WEAPONFLAG3_KNIFERELOAD, // flags3
};
...
struct weapon invitem_bolt = {
	...
	L_GUN_000, // description
	0, // flags
	WEAPONFLAG2_PICKUPSINGLE | WEAPONFLAG2_NOPICKUPINFLIGHT | WEAPONFLAG2_STICKSTOWALL | WEAPONFLAG2_BLADEHIT, // flags2
};
...
#ifndef PLATFORM_N64
struct weapon g_GeWeaponDefs[NUM_GE_WEAPONS];
#endif
...
#ifndef PLATFORM_N64
	// GoldenEye's guns: copies of their hosts, made at start-up (geguns.c)
	[WEAPON_GE_PP7             ] = &g_GeWeaponDefs[WEAPON_GE_PP7 - WEAPON_GE_FIRST],
	[WEAPON_GE_PP7SILENCED     ] = &g_GeWeaponDefs[WEAPON_GE_PP7SILENCED - WEAPON_GE_FIRST],
	[WEAPON_GE_DD44            ] = &g_GeWeaponDefs[WEAPON_GE_DD44 - WEAPON_GE_FIRST],
	[WEAPON_GE_KLOBB           ] = &g_GeWeaponDefs[WEAPON_GE_KLOBB - WEAPON_GE_FIRST],
	[WEAPON_GE_KF7SOVIET       ] = &g_GeWeaponDefs[WEAPON_GE_KF7SOVIET - WEAPON_GE_FIRST],
	[WEAPON_GE_ZMG             ] = &g_GeWeaponDefs[WEAPON_GE_ZMG - WEAPON_GE_FIRST],
	[WEAPON_GE_D5K             ] = &g_GeWeaponDefs[WEAPON_GE_D5K - WEAPON_GE_FIRST],
	[WEAPON_GE_D5KSILENCED     ] = &g_GeWeaponDefs[WEAPON_GE_D5KSILENCED - WEAPON_GE_FIRST],
	[WEAPON_GE_PHANTOM         ] = &g_GeWeaponDefs[WEAPON_GE_PHANTOM - WEAPON_GE_FIRST],
	[WEAPON_GE_AR33            ] = &g_GeWeaponDefs[WEAPON_GE_AR33 - WEAPON_GE_FIRST],
	[WEAPON_GE_RCP90           ] = &g_GeWeaponDefs[WEAPON_GE_RCP90 - WEAPON_GE_FIRST],
	[WEAPON_GE_SHOTGUN         ] = &g_GeWeaponDefs[WEAPON_GE_SHOTGUN - WEAPON_GE_FIRST],
	[WEAPON_GE_AUTOSHOTGUN     ] = &g_GeWeaponDefs[WEAPON_GE_AUTOSHOTGUN - WEAPON_GE_FIRST],
	[WEAPON_GE_SNIPERRIFLE     ] = &g_GeWeaponDefs[WEAPON_GE_SNIPERRIFLE - WEAPON_GE_FIRST],
	[WEAPON_GE_COUGARMAGNUM    ] = &g_GeWeaponDefs[WEAPON_GE_COUGARMAGNUM - WEAPON_GE_FIRST],
	[WEAPON_GE_GOLDENGUN       ] = &g_GeWeaponDefs[WEAPON_GE_GOLDENGUN - WEAPON_GE_FIRST],
	[WEAPON_GE_MOONRAKER       ] = &g_GeWeaponDefs[WEAPON_GE_MOONRAKER - WEAPON_GE_FIRST],
	[WEAPON_GE_GRENADELAUNCHER ] = &g_GeWeaponDefs[WEAPON_GE_GRENADELAUNCHER - WEAPON_GE_FIRST],
	[WEAPON_GE_ROCKETLAUNCHER  ] = &g_GeWeaponDefs[WEAPON_GE_ROCKETLAUNCHER - WEAPON_GE_FIRST],
	[WEAPON_GE_HUNTINGKNIFE    ] = &g_GeWeaponDefs[WEAPON_GE_HUNTINGKNIFE - WEAPON_GE_FIRST],
	[WEAPON_GE_THROWINGKNIFE   ] = &g_GeWeaponDefs[WEAPON_GE_THROWINGKNIFE - WEAPON_GE_FIRST],
	[WEAPON_GE_GRENADE         ] = &g_GeWeaponDefs[WEAPON_GE_GRENADE - WEAPON_GE_FIRST],
...
_Static_assert(ARRAYCOUNT(g_Weapons) == NUM_WEAPONS,
...
const u8 g_GeWeaponHosts[NUM_GE_WEAPONS] = {
	...
	[WEAPON_GE_KLOBB           - WEAPON_GE_FIRST] = WEAPON_KL01313,
	[WEAPON_GE_KF7SOVIET       - WEAPON_GE_FIRST] = WEAPON_KF7SPECIAL,
	[WEAPON_GE_ZMG             - WEAPON_GE_FIRST] = WEAPON_ZZT,
	[WEAPON_GE_D5K             - WEAPON_GE_FIRST] = WEAPON_DMC,
	[WEAPON_GE_D5KSILENCED     - WEAPON_GE_FIRST] = WEAPON_DMC,
	[WEAPON_GE_PHANTOM         - WEAPON_GE_FIRST] = WEAPON_CMP150,
	[WEAPON_GE_AR33            - WEAPON_GE_FIRST] = WEAPON_AR53,
	[WEAPON_GE_RCP90           - WEAPON_GE_FIRST] = WEAPON_RCP45,
	[WEAPON_GE_SHOTGUN         - WEAPON_GE_FIRST] = WEAPON_SHOTGUN,
	[WEAPON_GE_AUTOSHOTGUN     - WEAPON_GE_FIRST] = WEAPON_SHOTGUN,
	[WEAPON_GE_SNIPERRIFLE     - WEAPON_GE_FIRST] = WEAPON_SNIPERRIFLE,
	[WEAPON_GE_COUGARMAGNUM    - WEAPON_GE_FIRST] = WEAPON_DY357MAGNUM,
	[WEAPON_GE_GOLDENGUN       - WEAPON_GE_FIRST] = WEAPON_DY357LX,
	[WEAPON_GE_MOONRAKER       - WEAPON_GE_FIRST] = WEAPON_LASER,
	[WEAPON_GE_GRENADELAUNCHER - WEAPON_GE_FIRST] = WEAPON_DEVASTATOR,
	[WEAPON_GE_ROCKETLAUNCHER  - WEAPON_GE_FIRST] = WEAPON_ROCKETLAUNCHER,
	[WEAPON_GE_HUNTINGKNIFE    - WEAPON_GE_FIRST] = WEAPON_COMBATKNIFE,
	[WEAPON_GE_THROWINGKNIFE   - WEAPON_GE_FIRST] = WEAPON_COMBATKNIFE,
	[WEAPON_GE_GRENADE         - WEAPON_GE_FIRST] = WEAPON_GRENADE,
