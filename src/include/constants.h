...
#define DESCRIPTION_PATCHNOTES     0x0d // port: patchnotes.c
...
#define FUNCFLAG_LASERSTREAM            0x00000010 // Fires the laser's continuous stream: the beam drawn as a stream, the hum, hits that stream
...
#define PROJECTILEFLAG_GEROCKET    0x00000200 // Port: GoldenEye's 0x200, set by its ObjectRocketLaunch (aiGeObjectRocketLaunch)
...
#define WEAPONFLAG2_BLADEHIT         0x00100000 // Is a blade: the knife's sound on a chr, metal on anything else, no ricochet, and thrown it embeds where it lands
...
#define BUTTON_FIRELEFT       CONT_0040 // Akimbo Triggers: the left hand's own trigger
#define BUTTON_FIREMODELEFT   CONT_0080 // Akimbo Triggers: the left hand's own fire mode toggle
